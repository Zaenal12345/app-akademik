...
class Jurusan extends CI_Controller
{
	...
	public function show()
	{
		...
		$this->datatables->add_column('view','<a href="#" class="edit-jurusan btn btn-warning btn-sm" data-id="$1"><i class="feather icon-edit"></i></a> <a href="#" class="delete-jurusan btn btn-danger btn-sm" data-id="$1"><i class="feather icon-trash"></i></a>','id_jurusan');
